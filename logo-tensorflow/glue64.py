import sys, os
sys.path.insert(0, '/home/sallese/logo-tensorflow/logo-tensorflow/file')
import resize
import numpy as np
...
def main():
	# resize.resize_all_in_dir("/home/sallese/logo-tensorflow/logo-tensorflow/file/test-resize/", 500)
	image_names, Y_train = load_ys("/home/sallese/logo-tensorflow/logo-tensorflow/trainset-indexed.txt")
	# print(Y_train)
	# print(Y_train.shape)
	...
	# X_train = load_xs("/home/sallese/logo-tensorflow/logo-tensorflow/resized-images/", image_names)
	X_train = load_xs("/home/sallese/logo-tensorflow/logo-tensorflow/resized-images-small/", image_names)
	...
	# X, Y = create_placeholders(12288, 32)
...
def load_ys(filename):
	...
	# print(Y_train[0])
	# print(image_names)
	im = Image.open('/home/sallese/logo-tensorflow/logo-tensorflow/flatten.jpg')
	data = np.array(im)
	flattened = data.flatten()

	im2 = Image.open('/home/sallese/logo-tensorflow/logo-tensorflow/flatten.jpg')
	data2 = np.array(im2)
...
def load_xs(path_to_pictures, image_names):
	# print("LOADING XS")
	X_train = np.zeros((12288, 0), dtype=int)
	print(X_train.shape)
